...
export default function Hero() {
  ...
  const stats = [
    { label: "Élèves Accompagnés", value: "+100" },
  ...
  return (
    <section id="accueil" className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-32 pb-16">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-primary/50 via-primary/30 to-primary/90"></div>
      </div>
      ...
      >
        ...
        >
          ...
          <span className="text-brand-red">Soutien Scolaire au Togo</span>
        </motion.h1>
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
          <Link
            href="#contact"
            className="px-10 py-4 rounded-full bg-brand-red text-primary font-bold text-lg hover:bg-brand-red-light transition-all shadow-lg transform hover:-translate-y-1 hover:shadow-brand-red/20 active:scale-95"
          >
